...
export async function main(ns) {
    ...
    let focus = true; // Whether or not you want the grafting task to be focused on. Redundant and automatically disabled if you have the Neural-Retention Enhancement.
